...
$("#form_username").focus(function(){
    $("#form_label_username").css("background-position", "0 -96px");
});
$("#form_username").blur(function(){
    $("#form_label_username").css("background-position", "0 -72px");
});
$("#form_name1").focus(function(){
    $("#form_label_name1").css("background-position", "0 -96px");
});
$("#form_name1").blur(function(){
    $("#form_label_name1").css("background-position", "0 -72px");
});
$("#form_name2").focus(function(){
    $("#form_label_name2").css("background-position", "0 -96px");
});
$("#form_name2").blur(function(){
    $("#form_label_name2").css("background-position", "0 -72px");
});
$("#form_name").focus(function(){
    $("#form_label_name").css("background-position", "0 -96px");
});
$("#form_name").blur(function(){
    $("#form_label_name").css("background-position", "0 -72px");
});
...
$("#form_password").blur(function(){
    $("#form_label_password").css("background-position", "0 -144px");
});
$("#form_password1").focus(function(){
    $("#form_label_password1").css("background-position", "0 -168px");
});
$("#form_password1").blur(function(){
    $("#form_label_password1").css("background-position", "0 -144px");
});
$("#form_password2").focus(function(){
    $("#form_label_password2").css("background-position", "0 -168px");
});
$("#form_password2").blur(function(){
    $("#form_label_password2").css("background-position", "0 -144px");
});

$("#form_cellphone").focus(function(){
    $("#form_label_cellphone").css("background-position", "0 -24px");
});
$("#form_cellphone").blur(function(){
    $("#form_label_cellphone").css("background-position", "0 0");
});
$("#form_phone1").focus(function(){
    $("#form_label_phone1").css("background-position", "0 -24px");
});
$("#form_phone1").blur(function(){
    $("#form_label_phone1").css("background-position", "0 0");
});
$("#form_phone2").focus(function(){
    $("#form_label_phone2").css("background-position", "0 -24px");
});
$("#form_phone2").blur(function(){
    $("#form_label_phone2").css("background-position", "0 0");
});


$("#form_studentid1").focus(function(){
    $("#form_label_studentid1").css("background-position", "0 -240px");
});
$("#form_studentid1").blur(function(){
    $("#form_label_studentid1").css("background-position", "0 -216px");
});
$("#form_studentid2").focus(function(){
    $("#form_label_studentid2").css("background-position", "0 -240px");
});
$("#form_studentid2").blur(function(){
    $("#form_label_studentid2").css("background-position", "0 -216px");
});